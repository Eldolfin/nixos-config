{ config, pkgs, ... }:
{
  ...
  environment.etc = {
    ...
    "libvirt/hooks/qemu.d/win10-2/prepare/begin/start.sh" = {
      text =
        ''
          #!/run/current-system/sw/bin/bash

          # Debugging
          # exec 19>/home/oscar/Desktop/startlogfile
          # BASH_XTRACEFD=19
          # set -x
          ...
          # Logout
          source "/home/oscar/Desktop/Sync/Files/Tools/logout.sh"
    ...
    "libvirt/hooks/qemu.d/win10-2/release/end/stop.sh" = {
      text =
        ''
          #!/run/current-system/sw/bin/bash

          # Debugging
          # exec 19>/home/oscar/Desktop/stoplogfile
          # BASH_XTRACEFD=19
          # set -x
    ...
    # "libvirt/vgabios/patched.rom".source = /home/oscar/Desktop/Sync/Files/Linux_Config/symlinks/patched.rom;
  };
}
